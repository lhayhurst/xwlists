...
def header():
    return ['Tourney', 'tourneyType', 'tourneyDate', 'player', FACTION, 'points', 'swiss_standing', 'elim_standing', \
            ...
            SALVAGED_ASTROMECH_DROID_CANON + ".1",
            ILLICIT + ".1",
            ILLICIT_CANON + ".1",
            ILLICIT + ".2",
            ILLICIT_CANON + ".2",
...
sets_and_expansions = {'Core Set': [],
                       ...
                       'Wave 8': ['Punishing One Expansion Pack', 'Ghost Expansion Pack',
                                  'Tie Inquisitor Expansion Pack',
                                  'T-70 X-Wing Expansion Pack,' 'Mist Hunter Expansion Pack', 'TIE/fo Expansion Pack'],
                       'Wave 9': ['Protectorate Starfighter Expansion Pack', 'ARC-170 Expansion Pack',
                                  'Shadow Caster Expansion Pack', 'Special Forces TIE Expansion Pack'],
...
upgrades = {
    CREW: (
        ...
        {'name': 'Unkar Plutt', 'canon_name': 'unkarplutt', 'cost': 1, 'constraints': (SCUM_FACTION_CONSTRAINT)},
    ...
    DROID: (
        ...
        {'name': 'Targeting Astromech', 'canon_name': 'targetingastromech', 'cost': 2},
        {'name': 'R3 Astromech', 'cost': 2}
...
ships = {
    ...
    ALPHA_CLASS_STAR_WING: (
        ...
        {   'canon_name': u'rhosquadronveteran',
            'constraints': (IMPERIAL_FACTION_CONSTRAINT),
            'cost': 21,
            'faction': IMPERIAL,
            'name': u'Rho Squadron Veteran',
            'pilot_skill': 4,
            'ship_size': u'small',
            'upgrades': (EPT, MISSILE, TORPEDO, MOD, TITLE, TITLE)},
    ...
    QUADJUMPER: (
        {'ship_size': SMALL_SHIP, 'faction': SCUM, 'name': 'Jakku Gunrunner', 'cost': 15,
         'canon_name': 'jakkugunrunner',
        ...
        {'ship_size': SMALL_SHIP, 'faction': SCUM, 'name': 'Constable Zuvio', 'cost': 19,
         'canon_name': 'constablezuvio',
         'upgrades': (EPT, CREW, BOMB, TECH, ILLICIT, MOD),
         'constraints': (PER_SQUAD_UNIQUE_CONSTRAINT,),
         'pilot_skill': 7,
         },
    ...
    PROTECTORATE_STARFIGHTER: (
        ...
        {'ship_size': SMALL_SHIP, 'faction': SCUM, 'name': 'Concord Dawn Ace', 'cost': 23,
         'canon_name': 'concorddawnace',
         'upgrades': (EPT, TORPEDO, TITLE, MOD),
         'pilot_skill': 5,
         },
        {'ship_size': SMALL_SHIP, 'faction': SCUM, 'name': 'Concord Dawn Veteran', 'cost': 22,
         'canon_name': 'concorddawnace',
         'upgrades': (EPT, TORPEDO, TITLE, MOD),
         'pilot_skill': 3,
         },
        {'ship_size': SMALL_SHIP, 'faction': SCUM, 'name': 'Zealous Recruit', 'cost': 20,
         'canon_name': 'zealousrecruit',
    ...
    TIE_SF_FIGHTER: (
        {'ship_size': SMALL_SHIP, 'faction': IMPERIAL, 'name': 'Zeta Specialist', 'cost': 23,
         'canon_name': 'zetaspecialist',
         'upgrades': (SYSTEM, MISSILE, TECH, TITLE, MOD),
         'pilot_skill': 3,
         },
        {'ship_size': SMALL_SHIP, 'faction': IMPERIAL, 'name': '\"Backdraft\"', 'cost': 27,
         'canon_name': 'ruthlessfreelancer',
        ...
        {'ship_size': SMALL_SHIP, 'faction': IMPERIAL, 'name': 'Omega Specialist', 'cost': 25,
         'canon_name': 'omegaspecialist',
         'upgrades': (EPT, SYSTEM, MISSILE, TECH, TITLE, MOD),
         'pilot_skill': 5,
         },
    ),
    ...
    LANCER_CLASS_PURSUIT_CRAFT: (
        ...
        {'ship_size': LARGE_SHIP, 'faction': SCUM, 'name': 'Shadowport Hunter', 'cost': 33,
         'canon_name': 'shadowporthunter',
         'upgrades': (CREW, ILLICIT, ILLICIT, TITLE, MOD),
         'pilot_skill': 2,
         },
    ...
    G1A_STARFIGHTER: (
        ...
        {'ship_size': SMALL_SHIP, 'faction': SCUM, 'name': 'Ruthless Freelancer', 'cost': 23,
         'canon_name': 'ruthlessfreelancer',
    ...
    TIE_ADVANCED_PROTOTYPE: (
        ...
        {'ship_size': SMALL_SHIP, 'faction': IMPERIAL, 'name': 'Baron of the Empire', 'cost': 19,
         'canon_name': 'baronoftheempire',
         # 'constraints': (PER_SQUAD_UNIQUE_CONSTRAINT,),
        ...
        {'ship_size': SMALL_SHIP, 'faction': IMPERIAL, 'name': 'The Inquisitor', 'cost': 25,
         'canon_name': 'theinquisitor',
         'constraints': (PER_SQUAD_UNIQUE_CONSTRAINT,),
         'upgrades': (EPT, MISSILE, TITLE, MOD),
         'pilot_skill': 8,
         },
    ...
    Z95_HEADHUNTER: ({'ship_size': SMALL_SHIP, 'faction': REBEL, 'name': 'Airen Cracken', 'cost': 19,
                     ...
                     {'ship_size': SMALL_SHIP, 'faction': SCUM, 'name': 'Black Sun Soldier',
                      ...
                      'cost': 13,
                      'upgrades': (MISSILE, MOD, ILLICIT)},
                     {'ship_size': SMALL_SHIP, 'faction': SCUM, 'name': 'Kaa\'to Leeachos',
                      'canon_name': 'kaatoleeachos',
                      'cost': 15,
                      'upgrades': (EPT, MISSILE, MOD, ILLICIT)},
                     {'ship_size': SMALL_SHIP, 'faction': SCUM, 'name': 'N\'dru Suhlak',
    ...
    TIE_FIGHTER: (
        ...
        {'ship_size': SMALL_SHIP, 'faction': REBEL, 'name': '\"Zeb\" Orrelios', 'cost': 13,
    ...
    UPSILON_CLASS_SHUTTLE:
        ({'ship_size': LARGE_SHIP, 'faction': IMPERIAL, 'name': 'Starkiller Base Pilot', 'cost': 30,
         ...
         {'ship_size': LARGE_SHIP, 'faction': IMPERIAL, 'name': 'Major Stridan', 'cost': 32,
          'constraints': (PER_SQUAD_UNIQUE_CONSTRAINT,),
          'upgrades': (SYSTEM, CREW, CREW, TECH, TECH, TITLE, MOD)},

         {'ship_size': LARGE_SHIP, 'faction': IMPERIAL, 'name': 'Kylo Ren', 'cost': 34,
          'constraints': (PER_SQUAD_UNIQUE_CONSTRAINT,),
    ...
    TIE_INTERCEPTOR: ({'ship_size': SMALL_SHIP, 'faction': IMPERIAL, 'name': 'Soontir Fel', 'cost': 27,
                      ...
                      {'ship_size': SMALL_SHIP, 'faction': IMPERIAL, 'name': 'Kir Kanos', 'cost': 24,
                       'constraints': (PER_SQUAD_UNIQUE_CONSTRAINT,),
                       'upgrades': (TITLE, MOD)},
                      {'ship_size': SMALL_SHIP, 'faction': IMPERIAL, 'name': 'Lieutenant Lorrir', 'cost': 23,
                       'constraints': (PER_SQUAD_UNIQUE_CONSTRAINT,),
                       'upgrades': (TITLE, MOD)},
    ...
    M3_A_INTERCEPTOR: (
        ...
        {'ship_size': SMALL_SHIP, 'faction': SCUM, 'name': 'Laetin A\'shera', 'canon_name': 'laetinashera', 'cost': 18,
         'constraints': (PER_SQUAD_UNIQUE_CONSTRAINT, SCUM_FACTION_CONSTRAINT),
         'upgrades': (TITLE, MOD)},
    ...
    TIE_PUNISHER: [
        ...
        {'ship_size': SMALL_SHIP, 'faction': IMPERIAL, 'name': '\"Deathrain\"', 'canon_name': 'deathrain', 'pilot_skill': 6,
         ...
         'constraints': (PER_SQUAD_UNIQUE_CONSTRAINT, IMPERIAL_FACTION_CONSTRAINT),
         'upgrades': (SYSTEM, TORPEDO, TORPEDO, MISSILE, MISSILE, BOMB, BOMB, MOD)},
        {'ship_size': SMALL_SHIP, 'faction': IMPERIAL, 'name': 'Black Eight Squadron Pilot',
